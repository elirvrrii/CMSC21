...
void scan_word(int occurences[26]); //function prototypes
...
void scan_word(int occurences[26]){ //function to determine the count of the word in user input
...
bool is_anagram(int occurences1[26], int occurences2[26]){ //function to determine if both words are anagrams
